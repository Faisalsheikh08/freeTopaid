        ...
        <div className="container relative z-10 px-4 md:px-6">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mb-6 text-4xl font-bold tracking-tight text-white md:text-5xl lg:text-6xl">
              Follow any YT playlist like a structured <span className="text-red-500">paid course</span>
            </h1>
            <p className="mx-auto mb-10 max-w-2xl text-lg text-gray-300 md:text-xl">
              Track your learning, take AI-powered quizzes, crack exercises, and master every topic straight from YouTube playlists.
            </p>
