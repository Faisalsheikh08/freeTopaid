  ...
  const generateDocumentation = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        console.error('Failed to generate documentation:', data.error);
        alert(`Failed to generate documentation: ${data.error}`);
      }
    } catch (error) {
      console.error('Failed to generate documentation:', error);
      alert('Failed to generate documentation. Please check your internet connection and try again.');
    } finally {
